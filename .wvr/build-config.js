  ...
  copy: [
    ...
    },
    {
      ...
      transform(content) {
        return content
          .toString()
          .replace('${AUTH_SERVICE_URL}',  'window.location.protocol + \'//\' + window.location.host + window.location.base + \'/login/ShibbolethAuthentication/return'')
  //        .replace('${AUTH_SERVICE_URL}', '\'https://idp.jh.edu/idp/shibboleth\'')
